...
def go(args):
    ...
    # we're not using a temporary directory, so, we don't need to use artifact.wait() here
    ######################################
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Random forest configuration. A path to a JSON file representing a dict that will be passed to the scikit-learn constructor for RandomForestRegressor.",
    )
